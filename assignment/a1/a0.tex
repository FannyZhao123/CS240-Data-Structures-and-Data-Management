...
\begin{center}\begin{tikzpicture}[
  ...
  level 2/.style={sibling distance=100 pt},
  level 3/.style={sibling distance=60 pt},
  level 4/.style={sibling distance=30 pt},
]
  \node {M$_0$}
    child {node {F$_0$}
      child {node {C$_0$}
...
\begin{tikzpicture}
		...
		\fill (3, 2) circle[radius=2.5pt] node[right]{(3, 2)};		\fill (6, 6) circle[radius=2.5pt] node[right]{(6, 6)};
		\fill (0, 9) circle[radius=2.5pt] node[right]{(0, 9)};
		\fill (9, 8) circle[radius=2.5pt] node[right]{(9, 8)};
		\fill (8, 0) circle[radius=2.5pt] node[right]{(8, 0)};		\fill (5, 4) circle[radius=2.5pt] node[right]{(5, 4)};
...
\begin{figure}
\begin{center}
        \includegraphics[scale=0.5]{Siberian_Husky.jpg}
\end{center}
